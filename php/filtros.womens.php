...
<body style="z-index:9999" id="body_busqueda">
...
<script>
    function cambiarOrden() {
        ...
        xhr.open('GET', `filtros_womens.php?orden=${encodeURIComponent(ordenSeleccionado)}&timestamp=${new Date().getTime()}`, true);
